...
- (UILabel*)nameLabel
{
    if(_nameLabel == nil)
    {
        _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 5, self.bounds.size.width - 120, 30)];
...
- (UILabel*)addressLine1Label
{
    ...
    {
        _addressLine1Label = [[UILabel alloc] initWithFrame:CGRectMake(10, 35, self.bounds.size.width - 120, 20)];
...
- (UILabel*)addressLine2Label
{
    ...
    {
        _addressLine2Label = [[UILabel alloc] initWithFrame:CGRectMake(10, 55, self.bounds.size.width - 120, 20)];
